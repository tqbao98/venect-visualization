        ...
        <div id="w-node-d1068e0b76ce-067fc124" class="about_row cc-team">
          ...
          <ul id="w-node-d1068e0b76d1-067fc124" class="about_founder-ul w-list-unstyled">
            <li class="about_founder-li">
              ...
              <p class="about_founder-title">Project Leader</p>
            </li>
            <li class="about_founder-li">
              ...
              <p class="about_founder-title">Technical Leader</p>
              </li>
            <li class="about_founder-li">
            <img src="https://www.hamk.fi/wp-content/uploads/2019/03/Väisänen_Timo_240X240-150x150.jpg"  alt="" class="about_team-photo"/>
              ...
              <p class="about_founder-title">ORC Specialist</p>
              </li>
            <li class="about_founder-li">
              ...
              <p class="about_founder-title">Control Engineering Specialist</p>
            </li>
            <li class="about_founder-li">
              ...
              <p class="about_founder-title">Communication Specialist</p>
            </li>
            <li class="about_founder-li">
              <img src="https://www.hamk.fi/wp-content/uploads/2019/10/Ari-Lindgren-2019.jpg"  alt="" class="about_team-photo"/>
              <h3 class="about_founder-name">Ari Lindgren</h3>
              <p class="about_founder-title">Project Engineer</p>
              </li>
            <li class="about_founder-li">
            ...
            <li class="about_founder-li">
              ...
              <p class="about_founder-title">Research Assistant</p>
            </li>
          </ul>
          </div>
        </div>
